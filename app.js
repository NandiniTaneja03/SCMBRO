...
// Questions array
const questions = [
  new Question("What is the capital of France?", ["Berlin", "Madrid", "Paris", "Rome"], "Paris", "Hint: It's known as the 'City of Light'."),
  new Question("What is 2 + 2?", ["3", "4", "5", "6"], "4", "Hint: It’s the first even number greater than 3."),
  new Question("What is the capital of Spain?", ["Madrid", "Barcelona", "Lisbon", "Seville"], "Madrid", "Hint: It’s also the largest city in Spain."),
  new Question("What currency is used in Japan?", ["Dollar", "Euro", "Yen", "Peso"], "Yen", "Hint: The symbol looks like '¥'.")
];
