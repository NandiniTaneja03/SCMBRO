    ...
    const init = () => {
        ...
        setTimeout(() => {
            new fw(cOb.w / 2, cOb.h / 2, 125 + 50 * Math.random());
    ...
    function spark(ix, iy, r, fx, fy) {
        ...
        this.draw = () => {
            ...
            cOb.ctx.fillStyle = `rgba(${r},${g},${b},${a})`; // Fixed missing parenthesis
            cOb.ctx.beginPath();
            points.forEach((p, i) => {
